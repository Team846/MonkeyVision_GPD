        ...
        for j in range(3):
            for k in range(7):
                for l in range(3):
                    ...
                    new_image_path = os.path.join(ALGAE_IMAGES_AUGMENTED, f"algae_image_2_{i}{j}{k}{l}.jpg")
...
ALGAE_IMAGES_AUGMENTED_3 = "/Users/rayming/MonkeyVision_GPD/ALGAE_IMAGES_AUGMENTED_3"
augment_images = read_images_from_folder(ALGAE_IMAGES_AUGMENTED_3)
...
for i, img_path in enumerate(augment_images):
   ...
   new_image_path = os.path.join(ALGAE_IMAGES_AUGMENTED_RESIZED, f"algae_image_3_{i}.jpg")
