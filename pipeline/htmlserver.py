...
import os
from localization.vision22 import (
    VISION_L_H,
    VISION_L_S,
    VISION_L_V,
    VISION_U_H,
...
class HTMLServer:
    ...
    def __init__(self, vision_main: VisionMain):
        ...
        self.app.callback(
            Output("fake-output", "children"), [Input("framecomp-slider", "value")]
        )(self.framecomp_callback)

        self.app.callback(
            Output("fake-output-3", "children"), [Input("lowerH-slider", "value")]
        )(self.lowerH_callback)

        self.app.callback(
            Output("fake-output-4", "children"), [Input("lowerS-slider", "value")]
        )(self.lowerS_callback)

        self.app.callback(
            Output("fake-output-5", "children"), [Input("lowerV-slider", "value")]
        )(self.lowerV_callback)

        self.app.callback(
            Output("fake-output-6", "children"), [Input("upperH-slider", "value")]
        )(self.upperH_callback)

        self.app.callback(
            Output("fake-output-7", "children"), [Input("upperS-slider", "value")]
        )(self.upperS_callback)

        self.app.callback(
            Output("fake-output-8", "children"), [Input("upperV-slider", "value")]
        )(self.upperV_callback)

        self.app.callback(
            Output("fake-output-9", "children"), [Input("minArea-slider", "value")]
        ...
        self.app.callback(
            Output("fake-output-11", "children"), [Input("percentage-slider", "value")]
