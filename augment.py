...
ALGAE_IMAGES_AUGMENTED_1 = "/Users/rayming/MonkeyVision_GPD/ALGAE_IMAGES_AUGMENTED_1"
augment_images = read_images_from_folder(ALGAE_IMAGES_AUGMENTED_1)
...
for i, img_path in enumerate(augment_images):
   ...
   new_image_path = os.path.join(ALGAE_IMAGES_AUGMENTED_RESIZED, f"algae_image_1_{i}.jpg")
